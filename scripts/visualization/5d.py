...
df_plot = df.dropna(subset=['Ni_Content', 'Trigger_Temperature']).copy()
...
plt.tight_layout()
plt.savefig('supp_fig_s1_ni_content_vs_trigger_temperature.png', dpi=300, bbox_inches='tight')
plt.show()
